    ...
    <section id="comecar" className="section-pad scroll-mt-24">
      <div className="mx-auto max-w-6xl">
        <Reveal variant="scale">
          ...
          >
            <div className="pointer-events-none absolute -right-16 -top-16 size-56 rounded-full bg-white/10 animate-blob" />
            <div
              className="pointer-events-none absolute -bottom-20 -left-10 size-64 rounded-full bg-white/10 animate-blob"
